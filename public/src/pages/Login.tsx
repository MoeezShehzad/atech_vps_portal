...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    // OAuth Google Login Trigger
    console.log("Logging in with Google...");
  };

  const handleGithubLogin = () => {
    // OAuth GitHub Login Trigger
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <Link to="/" className="inline-flex items-center gap-3">
          ...
          {/* <span className="text-xl font-bold text-blue-950 font-poppins"></span> */}
        </Link>
        ...
        <div className="bg-white py-8 px-6 shadow-xl shadow-blue-950/5 border border-slate-200 rounded-2xl sm:px-10">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="/forgot-password" className="text-xs font-semibold text-blue-600 hover:text-blue-500">
                Forgot password?
              </a>
            </div>
